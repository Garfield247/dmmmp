...
@user.route("/register/", methods=["POST"], defaults={"desc": {"interface_name": "用户注册",
                                                               "is_permission": False,
...
@user.route("/activate/", methods=["POST"], defaults={"desc": {"interface_name": "用户激活",
                                                               "is_permission": False,
                                                               "permission_belong": None}})
def activate(desc):
    '''
...
@user.route("/login/", methods=["POST"], defaults={"desc": {"interface_name": "用户登录",
                                                               "is_permission": False,
                                                               "permission_belong": None}})
def login(desc):
    '''
...
@user.route("/forgetpwd/", methods=["POST"], defaults={"desc": {"interface_name": "找回密码",
                                                               "is_permission": False,
                                                               "permission_belong": None}})
def forgetpwd(desc):
    '''
...
@user.route('/changepwd/', methods=['PUT'], defaults={"desc": {"interface_name": "重设密码",
                                                               "is_permission": False,
                                                               "permission_belong": None}})
def changepwd(desc):
    '''
...
@user.route("/list/", methods=["GET"], defaults={"desc": {"interface_name": "用户列表",
                                                          "is_permission": True,
                                                          "permission_belong": 1}})
def ulist(desc):
    '''
...
@user.route("/info/", methods=["GET"], defaults={"desc": {"interface_name": "用户资料",
                                                          "is_permission": True,
                                                          "permission_belong": 0}})
def info(desc):
    '''
...
@user.route("/icon/", methods=["POST"], defaults={"desc": {"interface_name": "修改头像",
                                                          "is_permission": True,
                                                          "permission_belong": 0}})
def icon(desc):
    '''
...
@user.route("/changeprofile/", methods=["PUT"], defaults={"desc": {"interface_name": "修改资料",
                                                                   "is_permission": True,
                                                                   "permission_belong": 0}})
...
@user.route("/frozen/", methods=["POST"], defaults={"desc": {"interface_name": "冻结用户",
                                                             "is_permission": True,
                                                             "permission_belong": 1}})
...
@user.route("/del/", methods=["DELETE"], defaults={"desc": {"interface_name": "删除用户",
                                                             "is_permission": True,
                                                             "permission_belong": 1}})
def udel(desc):
    '''
