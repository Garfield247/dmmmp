...
@case.route("/all/", methods=["GET"], defaults={"desc": {"interface_name": "案例列表",
                                                         "is_permission": True,
                                                         "permission_belong": 1}})
def all(desc):
    """获取案例信息"""
...
@case.route("/post/", methods=["POST", "PUT"], defaults={"desc": {"interface_name": "添加、修改案例",
                                                                  "is_permission": True,
                                                                  "permission_belong": 1}})
def cpost(desc):
    """添加修改案例"""
...
@case.route("/del/", methods=["DELETE"], defaults={"desc": {"interface_name": "删除案例",
                                                            "is_permission": True,
                                                            "permission_belong": 2}})
def cdel(desc):
