...
@dbtable.route("/info/", methods=["GET"], defaults={"desc": {"interface_name": "获取数据表信息",
                                                             "is_permission": True,
                                                             "permission_belong": 0}})
def info(desc):
...
@dbtable.route("/column/", methods=["GET"], defaults={"desc": {"interface_name": "获取数据表的列信息",
                                                               "is_permission": True,
                                                               "permission_belong": 0}})
def column(desc):
    result = {
...
@dbtable.route("/columnsetting/", methods=["POST"], defaults={"desc": {"interface_name": "数据表的数据列设置",
                                                                       "is_permission": True,
                                                                       "permission_belong": 0}})
...
@dbtable.route("/del/", methods=["DEL"], defaults={"desc": {"interface_name": "删除数据表",
                                                            "is_permission": True,
                                                            "permission_belong": 1}})
def dbtdel(desc):
