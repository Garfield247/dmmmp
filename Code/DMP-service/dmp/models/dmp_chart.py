...
class Chart(db.Model, DMPModel):
    ...
    def chart_to_dict(self):
        chart_dict = {
            ...
            'query_string': eval(self.query_string) if self.query_string else None,
            'chart_data': eval(self.chart_data) if self.chart_data else None,
            'chart_type': self.chart_type,
            'params': self.params,
            'update_interval': self.update_interval,
            'update_unit': self.update_unit,
            'description': self.description,
            'charts_position': eval(self.charts_position) if self.charts_position else None,
