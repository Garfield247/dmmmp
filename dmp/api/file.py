...
@file.route("/upload/", methods=["POST"], defaults={"desc": {"interface_name": "文件上传",
                                                             "is_permission": True,
                                                             "permission_belong": 0}})
def upload(desc):
...
@file.route("/success/", methods=["GET"], defaults={"desc": {"interface_name": "文件上传完成",
                                                             "is_permission": True,
                                                             "permission_belong": 0}})
def success(desc):
...
@file.route("/dlcomplete/", methods=["GET"], defaults={"desc": {"interface_name": "文件下载完成",
                                                                "is_permission": True,
                                                                "permission_belong": 0}})
def dlcomplete(desc):
    result = {
