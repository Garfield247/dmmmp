...
class KylinTool():
    ...
    def __init__(self,host,port,user,pswd):
        ...
        print(self.headers)
        self.url_prefix = "http://{host}:{port}/kylin/api/".format(host=host,port=port)
    ...
    def _post(self,api,params=None):
        ...
        """
        r = requests.post(url=self.url_prefix+api,headers=self.headers,json=params)
        return r.status_code,r.text
    ...
    def _put(self,api,params=None):
        ...
        """
        r = requests.put(url=self.url_prefix+api,headers=self.headers,json=params)
        return r.status_code,r.text
    ...
    def _del(self,api,params=None):
        ...
        """
        r = requests.delete(url=self.url_prefix+api,headers=self.headers,json=params)
        return r.status_code,r.text
    ...
    def api_authentication(self):
        ...
        """
        code,data = self._post("authentication")
        return code,data
    ...
    def api_query(self,sql,offset=0,limit=None,acceptPartial=False,project="DEFAULT"):
        ...
        code,data = self._post("query",params=params)
        return code,data
    ...
    def api_prepare_query(self,sql,offset=0,limit=None,acceptPartial=False,project="DEFAULT"):
        ...
        code,data = self._post("query/prepare",params=params)
        return code,data
    ...
    def api_save_query(self,sql,name,project,description=None):
        ...
        code,data = self._post("saved_queries",params=params)
        return code,data
    ...
    def api_remove_saved_query(self,queryId):
        ...
        """
        code,data = self._del("saved_queries/{queryId}".format(queryId=queryId))
        return code,data
    ...
    def api_get_saved_queries(self):
        ...
        参数：无
        """
        code,data = self._get("saved_queries")
        return code,data
    ...
    def api_get_running_queries(self):
        ...
        参数：无
        """
        code,data = self._get("query/runningQueries")
        return code,data
    ...
    def api_stop_query(self,queryId):
        ...
        """
        code,data = self._get("query/{queryId}/stop".format(queryId=queryId))
        return code,data
    ...
    def api_list_queryable_tables(self,project=None):
        ...
        """
        code,data = self._get("tables_and_columns")
        return code,data
    ...
    def api_get_data_model(self,modeName):
        ...
        """
        code, data = self._get("model/{modeName}".format(modeName=modeName))
        return code,data
    ...
    def api_create_model(self,modelName ,modelDescData ,projectName):
        ...
        code,data = self._post("models",params=params)
        return code,data
    ...
    def api_get_model_desc_data(self,modelName=None ,projectName=None ,limit=None ,offset=None):
        ...
        code,data = self._get("models",params=params)
        return code,data
    ...
    def api_delete_model(self,modelName):
        ...
        modelName - 必需 string 数据模型名称
        """
        code,data = self._del("models/{modelName}".format(modelName=modelName))
        return code,data
    ...
    def api_clone_model(self,modelName):
        ...
        modelName - 必需 string 数据模型名称
        """
        code,data = self._put("models/{modelName}/clone".format(modelName=modelName))
        return code,data
    ...
    def api_create_cube(self,cubeName,cubeDescData,projectName):
        ...
        code,data = self._post("cubes",params=params)
        return code,data
    ...
    def api_update_cube(self,cubeName,cubeDescData,projectName):
        ...
        code,data = self._put("cubes",params=params)
        return code,data
    ...
    def api_get_cube(self,cubeName):
        ...
        """
        code, data = self._get("cubes/{cubeName}".format(cubeName=cubeName))
        return code,data
    ...
    def api_get_cube_descriptor(self,cubeName):
        ...
        """
        code, data = self._get("cube_desc/{cubeName}".format(cubeName=cubeName))
        return code,data
    ...
    def api_build_cube(self,cubeName,buildType,startTime=None,endTime=None):
        ...
        code, data = self._put("cube_desc/{cubeName}".format(cubeName=cubeName),params=params)
        return code,data
    ...
    def api_enable_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称。
        """
        code,data = self._put("cubes/{cubeName}/enable".format(cubeName=cubeName))
        return code,data
    ...
    def api_disable_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称。
        """
        code,data = self._put("cubes/{cubeName}/disable".format(cubeName=cubeName))
        return code,data
    ...
    def api_purge_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称。
        """
        code,data = self._put("cubes/{cubeName}/purge".format(cubeName=cubeName))
        return code,data
    ...
    def api_delete_segment(self,cubeName,segmentName):
        ...
        """
        code,data = self._del("cubes/{cubeName}/segs/{segmentName}".format(cubeName=cubeName,segmentName=segmentName))
        return code,data
    ...
    def api_auto_merge_segment(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data= self._put("cubes/{cubeName}/automerge".format(cubeName=cubeName))
        return code,data
    ...
    def api_get_sql_of_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._get("cubes/{cubeName}/sql".format(cubeName=cubeName))
        return code,data
    ...
    def api_force_rebuild_lookup_table_snapshot(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._put("cubes/{cubeName}/refresh_lookup".format(cubeName=cubeName))
        return code,data
    ...
    def api_clone_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._put("cubes/{cubeName}/clone".format(cubeName=cubeName))
        return code,data
    ...
    def api_delete_cube(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._del("cubes/{cubeName}".format(cubeName=cubeName))
        return code,data
    ...
    def api_migrate_cube(self,cubeName,projectName):
        ...
        """
        code,data = self._post("cubes/{cubeName}/{projectName}/migrate".format(cubeName=cubeName,projectName=projectName))
        return code,data
    ...
    def api_get_hbase_info(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._del("cubes/{cubeName}/hbase".format(cubeName=cubeName))
        return code,data
    ...
    def api_get_current_cuboid(self,cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._del("cubes/{cubeName}/cuboids/current".format(cubeName=cubeName))
        return code,data
    ...
    def api_full_segment_holes(self, cubeName):
        ...
        cubeName - 必需 string 多维数据集名称.
        """
        code,data = self._put("cubes/{cubeName}/holes".format(cubeName=cubeName))
        return code ,data
    ...
    def api_get_job_list(self,projectName,offset,limit,timeFilter,cubeName=None,status=None):
        ...
        code,data = self._get("jobs",params=params)
        return code,data
    ...
    def api_get_job_status_overview(self,projectName,offset,limit,timeFilter,cubeName=None,status=None):
        ...
        code,data = self._get("jobs/overview",params=params)
        return code,data
    ...
    def api_resume_job(self,jobId):
        ...
        """
        code,data = self._put("jobs/{jobId}/resume".format(jobId=jobId))
        return code,data
    ...
    def api_discard_job(self,jobId):
        ...
        jobId - 必须 string 任务ID
        """
        code,data = self._put("jobs/{jobId}/discard".format(jobId=jobId))
        return code,data
    ...
    def api_drop_job(self,jobId):
        ...
        jobId - 必须 string 任务ID
        """
        code,data = self._del("jobs/{jobId}/drop".format(jobId=jobId))
        return code,data
    ...
    def api_get_job_status(self,jobId):
        ...
        jobId - 必须 string 任务ID
        """
        code,data = self._get("jobs/{jobId}".format(jobId=jobId))
        return code,data
    ...
    def api_get_job_step_output(self,jobId,stepId):
        ...
        """
        code,data = self._get("jobs/{jobId}/steps/{stepId}/output".format(jobId=jobId,stepId=stepId))
        return code,data
    ...
    def api_resubmit_realtime_build_job(self,jobId):
        ...
        jobId - 必须 string 任务ID
        """
        code,data = self._put("jobs/{jobId}/resubmit".format(jobId=jobId))
        return code,data
    ...
    def api_rollback_job(self,jobId,stepId):
        ...
        """
        code,data = self._put("jobs/{jobId}/steps/{stepId}/rollbackt".format(jobId=jobId,stepId=stepId))
        return code,data
    ...
    def api_get_hive_tables(self,project,ext=False):
        ...
        code,data = self._get("tables",params=params)
        return code,data
    ...
    def api_unload_hive_tables(self,tables,project):
        ...
        """
        code,data = self._del("tables/{tables}/{project}".format(tables=tables,project=project))
        return code,data
    ...
    def api_show_database_in_hive(self):
        ...
        参数：无
        """
        code,data = self._get("tables/hive")
        return code,data
    ...
    def api_show_table_in_hive_database(self,databaseName):
        ...
        """
        code,data = self._get("tables/hive/{databaseName}".format(databaseName=databaseName))
        return code,data
    ...
    def api_get_user_can_query_query_the_table(self,project,utype,table):
        ...
        table - 必需 string 表名称
        """
        code,data = self._get("acl/table/{project}/{type}/{table}".format(project=project,utype=utype,table=table))
        return code,data
    ...
    def api_delete_user_from_table_blacklist(self,project,utype,table,name):
        ...
        name - 必需 string 要放入表黑名单的用户名或组名
        """
        code,data = self._post("table/{project}/{type}/{table}/{name}".format(project=project,utype=utype,table=table,name=name))
        return code,data
    ...
    def api_hot_load_kylin_config(self):
        ...
        参数：无
        """
        code,data = self._post("cache/announce/config")
        return code,data
    ...
    def api_get_streaming_config(self):
        ...
        参数：无
        """
        code,data = self._get("streaming/getConfig")
        return code,data
    ...
    def api_get_kafka_config(self):
        ...
        参数：无
        """
        code,data = self._get("streaming/getKfkConfig")
        return code,data
    ...
    def api_create_streaming_schema(self,project,tableData,StreamingConfig,kafkaConfig):
        ...
        code,data = self._post("streaming",params=params)
        return code,data
    ...
    def api_get_apecific_type_of_metrics(self,mtype):
        ...
        """
        code,data = self._get("jmetrics/{mtype}".format(mtype=mtype))
        return code,data
